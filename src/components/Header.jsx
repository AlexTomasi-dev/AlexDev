        ...
        <div className="container">
             <div className="row header-row-stile">
                 ...
                 <div className="col-12  col-lg-6 mia-img text-center my-auto">
                     <img src="C:\Users\pcale\Desktop\Portfolio Alex - originale - Copia\src\assets\mia-img.png" alt="Mia foto Alex Tomasi" />
                 </div>
             </div>
             
             <div className="row mt-2">
                 <div className="col-12 text-center p-header-css">
                     <h2>FRONT-END</h2>
                 </div>
             </div>
        </div>
